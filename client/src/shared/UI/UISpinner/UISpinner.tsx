import styles from "@/shared/UI/UISpinner/UISpinner.module.scss"

const UISpinner = ({ size = "md", fill = "var(--green)", style }: any) => {
	return (
		<div className={`${styles.wrapper} ${styles[size]}`} style={style}>
			<svg xmlns="http://www.w3.org/2000/svg" fill={fill} viewBox="0 0 50 50">
