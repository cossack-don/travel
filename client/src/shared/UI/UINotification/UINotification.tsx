...
export const UINotification: FC<UINotificationType> = ({ title, description, time = 100000, active = false }) => {
    const fps = 60;
        ...
        <div>
            {activePoint && createPortal(
                <div className={cls.wrapper}>
                    ...
                    <span className={cls.close} onClick={() => setActivePoint(false)}>X</span>
                </div>, document.body)
            }
        </div>
    )
